      ...
      <div className="footer-content">
        <div className="footer-logo">
          ...
          <p className="text-gray-600 mb-6 max-w-md">
            Creating beautiful and functional spaces with a focus on
            sustainability and innovation.
          </p>
          <div className="flex space-x-4">
            <button className="text-gray-600 hover:text-black bg-transparent border-none p-0 cursor-pointer">
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">
            &copy; {new Date().getFullYear()} Studio Abrash. All rights
            reserved.
          </div>
